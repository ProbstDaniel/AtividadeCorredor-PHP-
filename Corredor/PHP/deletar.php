...
if (isset($_GET['id'])) {
    ...
    try {
        ...
        if ($stmt->execute()) {
            ...
            header("Location: index.php?status=deleted&message=O participante foi excluído com sucesso");
            exit();
        } else {
            ...
            header("Location: index.php?status=delete_error&message=Não foi possível excluir o partcipante cadastrado");
            exit();
        }
